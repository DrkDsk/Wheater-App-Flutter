...
Future registerBlocs() async {
  ...
  final storeCityLocation = getIt<StoreLocationUseCase>();
  ...
  getIt.registerFactory<StoreCityBloc>(
    () => StoreCityBloc(
      storeLocationUseCase: storeCityLocation,
      observerLocationUseCase: observeLocationUseCase,
    ),
  );
}
